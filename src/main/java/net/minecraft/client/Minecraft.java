...
public class Minecraft implements IThreadListener {
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = getClass().getResourceAsStream("/assets/ruby/images/icons8-ruby-16.png");
                inputstream1 = getClass().getResourceAsStream("/assets/ruby/images/icons8-ruby-32.png");
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        GuiScreenOverrideEvent guiScreenOverrideEvent = new GuiScreenOverrideEvent(guiScreenIn);
        ...
        if (guiScreenOverrideEvent.screen == null && this.theWorld == null) {
            guiScreenOverrideEvent.screen = new GuiMainMenu();
        } else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F) {
            guiScreenOverrideEvent.screen = new GuiGameOver();
        }

        if (guiScreenOverrideEvent.screen instanceof GuiMainMenu) {
            this.gameSettings.showDebugInfo = false;
            this.ingameGUI.getChatGUI().clearChatMessages();
        }

        this.currentScreen = (GuiScreen) guiScreenOverrideEvent.screen;

        if (guiScreenOverrideEvent.screen != null) {
    ...
    public void resize(int width, int height) {
        ...
        new ResizeWindowEvent(width, height, this.displayWidth, this.displayHeight).post();
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    if (k == Keyboard.KEY_F4 && this.entityRenderer != null) {
