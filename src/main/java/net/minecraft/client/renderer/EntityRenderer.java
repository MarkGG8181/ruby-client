    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.currentScreen != null) {
                ...
                try {
                    this.mc.currentScreen.onRender(mouseX, mouseY, partialTicks);
            ...
            new UpdateCameraAndRenderEvent(partialTicks, mouseX, mouseY, scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight()).post();
        }
    }
