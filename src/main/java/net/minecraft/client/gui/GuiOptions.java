...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
    ...
    public void onInit() {
        ...
        this.buttonList.add(new GuiButton(100, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, I18n.format("options.controls")));
        this.buttonList.add(new GuiButton(103, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, I18n.format("options.chat.title")));
